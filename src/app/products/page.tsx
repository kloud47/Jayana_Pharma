      ...
      <div className="font-serif bg-primary/10 pb-20">
        <MaxWidthWrapper className="">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 my-10 border-b border-primary text-sm lg:text-lg py-2 pt-5 animate-slideinY opacity-0 [--slidein-delay:300ms]">
            ...
            <span className="z-10">Benfothiamine</span>
            <span className="z-10">Benfothiamine</span>
            <span className="z-10">Ammonium Chloride</span>
            <span className="z-10">Di Sodium Hydrogen Citrate</span>
            <span className="z-10">Sodium Citrate</span>
            <span className="z-10">Silodosin</span>
            <span className="z-10">Finasteride</span>
            <span className="z-10">Mirtazapine</span>
            <span className="z-10">Mupirocin</span>
            <span className="z-10">Rizatriptan</span>
            <span className="z-10">Oxyclozanide</span>
            <span className="z-10">Rafoxanide</span>
            <span className="z-10">Piperazine Hexahydrate</span>
            <span className="z-10">levamisole</span>
            <span className="z-10">Tylosin Tartrate</span>
            <span className="z-10">olanzapine</span>
            <span className="z-10">fluoxetine</span>
            <span className="z-10">Ranitidine</span>
            <span className="z-10">Albendazole</span>
            <span className="z-10">alfuzosin hydrochloride</span>
            <span className="z-10">alendronate sodium</span>
            <span className="z-10">allopurinol</span>
            <span className="z-10">amitriptyline HCL</span>
            <span className="z-10">amorolfine HCL</span>
            <span className="z-10">Amprolium</span>
            <span className="z-10">aripiprazole</span>
            <span className="z-10">azelaic acid</span>
            <span className="z-10">Azithroymcin</span>
            <span className="z-10">Betacarotene 20% & 10%</span>
            <span className="z-10">calcium dobesilate</span>
            <span className="z-10">halobetasol propionate</span>
            <span className="z-10">coenzyme q10</span>
            <span className="z-10">desvenlafaxine succinate</span>
            <span className="z-10">Diacerine</span>
            <span className="z-10">divalproex</span>
            <span className="z-10">valproic acid</span>
            <span className="z-10">Domperidone</span>
            <span className="z-10">donepezil</span>
            <span className="z-10">drotaverine</span>
            <span className="z-10">duloxetine</span>
            <span className="z-10">ebastine</span>
            <span className="z-10">dutasteride</span>
            <span className="z-10">escitaloprám oxalate</span>
            <span className="z-10">Esomeprazole Magnesium</span>
            <span className="z-10">etoricoxib</span>
            <span className="z-10">Luliconazole</span>
            <span className="z-10">sertaconazole nitrate</span>
            <span className="z-10">voriconazole</span>
            <span className="z-10">febuxostat</span>
            <span className="z-10">Fenbendazole</span>
            <span className="z-10">Fluconazole</span>
            <span className="z-10">Fusidic Acid</span>
            <span className="z-10">gamma benzene hexachloride</span>
            <span className="z-10">gabapentin</span>
            <span className="z-10">gentamicin sulphate</span>
            <span className="z-10">granisetron</span>
            <span className="z-10">Hydroquinone</span>
            <span className="z-10">ibandronate sodium</span>
            <span className="z-10">Ilaprazole</span>
            <span className="z-10">inositol</span>
            <span className="z-10">iodochlorhydroxyquinoline</span>
            <span className="z-10">isotretinoin</span>
            <span className="z-10">Itopride</span>
            <span className="z-10">ivabradine</span>
            <span className="z-10">Ivermectin</span>
            <span className="z-10">ketorolac</span>
            <span className="z-10">lacosamide</span>
            <span className="z-10">Lafutidine</span>
            <span className="z-10">leflunomide</span>
            <span className="z-10">Levetiracetam</span>
            <span className="z-10">Salbutamol Sulphate</span>
            <span className="z-10">Linezolid</span>
            <span className="z-10">Malt Extract</span>
            <span className="z-10">Mebeverin</span>
            <span className="z-10">Meloxicam</span>
            <span className="z-10">Methylcobalamine</span>
            <span className="z-10">Metoclopramide HCL</span>
            <span className="z-10">Metoprolol Tartrate & Succinate</span>
            <span className="z-10">Miconazole Nitrate</span>
            <span className="z-10">Mifepristone</span>
            <span className="z-10">minoxidil</span>
            <span className="z-10">Misoprostol</span>
            <span className="z-10">Neomycin Sulphate</span>
            <span className="z-10">Naproxen</span>
            <span className="z-10">nitrofurantoin</span>
            <span className="z-10">Ondesetron</span>
            <span className="z-10">oxcarbazepine</span>
            <span className="z-10">carbamazepine</span>
            <span className="z-10">Oxetacaine</span>
            <span className="z-10">Mannitol</span>
            <span className="z-10">Pepsin</span>
            <span className="z-10">Permethrine</span>
            <span className="z-10">fungal diastase</span>
            <span className="z-10">serratiopeptidase</span>
            <span className="z-10">phenylephrine hcl</span>
            <span className="z-10">Perferidone</span>
            <span className="z-10">Polymixin B Sulphate</span>
            <span className="z-10">Zinc bacitracin</span>
            <span className="z-10">Pregabalin</span>
            <span className="z-10">quetiapine fumarate</span>
            <span className="z-10">ramipril</span>
            <span className="z-10">Ranitidine</span>
            <span className="z-10">Rifaxmine</span>
            <span className="z-10">Resedronate Sodium</span>
            <span className="z-10">Rivaroxaban</span>
            <span className="z-10">sildenafil citrate</span>
            <span className="z-10">spironolactone</span>
            <span className="z-10">Torsemide</span>
            <span className="z-10">triprolidine HCL</span>
            <span className="z-10">ursodeoxycholic acid</span>
            <span className="z-10">Warfarin Sodium</span>
            <span className="z-10">acamprosate Calcium</span>
            <span className="z-10">adapalene</span>
            <span className="z-10">dried aluminium hydroxide gel</span>
            <span className="z-10">Magnesium Hydroxide</span>
            <span className="z-10">Magnesium Trisilicate</span>
            <span className="z-10">Zinc oxide</span>
            <span className="z-10">Bentonite</span>
            <span className="z-10">bromhexine</span>
            <span className="z-10">Calcium Carbonate</span>
            <span className="z-10">Calcium Lactate</span>
            <span className="z-10">Iron (III) Polymaltose Complex</span>
            <span className="z-10">Gliclazide</span>
            <span className="z-10">Glimepiride</span>
            ...
            <span className="z-10">Paracetamol</span>
          ...
          <div className="border-b border-primary mb-5">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 text-sm lg:text-lg mt-5 bg-muted p-2">
              ...
              <span>HPMC E5</span>
              <span>HPMC 15 CPS</span>
              <span>HPMC K100M</span>
              <span>HPMC K15M</span>
              <span>HPMC K4M</span>
              <span>HPMC K100 LV</span>
              <span>HPMC Phthalate HP 55</span>
              <span>Acrypol 940 / 971P / 974P</span>
              <span>PVPK (All Grades)</span>
              <span>Kollidon (All Grades)</span>
              <span>Ludipress</span>
              <span>Xanthan Gum</span>
              <span>C.M.C (All Grade)</span>
              <span>Colours and Flavours (All Type)</span>
              <span>P.E.G. (All Grade)</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 pt-4">
              ...
              <div className="grid grid-cols-2 bg-muted text-nowrap border-b border-primary">
                ...
                <div className="flex flex-col p-2">
                  ...
                  <span>Vitamin E Liquid</span>
                  <span>Vitamin E 50%</span>
                  <span>Vitamin D3</span>
                  <span>Vitamin A Palmitate</span>
                </div>
              </div>
              <div className="grid grid-cols-2 bg-muted text-nowrap border-b border-primary">
                <div className="bg-primary/10 flex flex-col justify-center items-center text-lg">
              ...
              <div className="grid grid-cols-2 bg-muted text-nowrap text-sm border-b border-primary">
                ...
                <div className="flex flex-col p-2 justify-center">
                  ...
                  <span>Itraconazole 22%, 40% & 44%</span>
                  <span>Multi Vitamin Pellets</span>
                </div>
              </div>
              <div className="grid grid-cols-2 bg-muted text-nowrap border-b border-primary">
                <div className="bg-primary/10 flex flex-col justify-center items-center text-lg">
                ...
                <div className="flex flex-col p-2">
                  ...
                  <span>Beclomethasone Salts</span>
                  <span>Clobetasole Propionate</span>
                  <span>Fluticasone Propionate</span>
                  <span>Fluocinolone Acetonide</span>
                  <span>Hydrocortisone</span>
                  <span>Deflazacort</span>
                </div>
              </div>
              <div className="grid grid-cols-2 bg-muted text-nowrap border-b border-primary">
                <div className="bg-primary/10 flex flex-col justify-center items-center text-lg">
              ...
              <div className="grid grid-cols-2 bg-muted border-b border-primary">
                ...
                <div className="flex flex-col p-2 justify-center">
                  ...
                  <span>Linagliptin</span>
                  <span>Vildagliptin</span>
                  <span>Dapagliflozin</span>
              ...
              <div className="grid grid-cols-2 bg-muted">
                ...
                <div className="flex flex-col p-2 justify-center">
                  <span>Atorvastatin Calcium</span>
                  <span>Losartan Potassium</span>
                  <span>Hydrochlorothiazide</span>
                  <span>Telmisartan</span>
                  <span>Valsartan</span>
                  <span>apixaban</span>
                  <span>amlodipine besylate</span>
                  <span>Atenolol</span>
                  <span>bisoprolol fumarate</span>
                  <span>cilnidipine</span>
                  <span>Citicoline Sodium</span>
                  <span>Digoxin</span>
                  <span>diluted nitroglycerin</span>
                  <span>Enalapril Maleate</span>
                  <span>ezetimibe</span>
                  <span>fenofibrate</span>
                  <span>furosemide</span>
                  <span>olmesartan</span>
                  <span>rosuvastatin calcium</span>
                </div>
              </div>
