      ...
      <div className="font-serif bg-primary/10 pb-20">
        <MaxWidthWrapper className="">
          <div className="pt-10 grid grid-cols-[40%_60%] h-[30vh] border-b border-primary">
            <h1 className="text-6xl font-bold uppercase bg-primary/20 flex items-center justify-center p-4 animate-slideinX opacity-0 [--slidein-delay:300ms]">
              Our Products
            </h1>
            <div className="BGProd2"></div>
          </div>
          <div className="grid grid-cols-4 my-10 border-b border-primary text-lg py-2 pt-5 animate-slideinY opacity-0 [--slidein-delay:300ms]">
