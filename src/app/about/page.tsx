    ...
    <MaxWidthWrapper>
      ...
      <div className="mt-20 grid grid-cols-[30%_70%]">
        ...
        <div className="bg-muted p-5 text-lg font-thin font-serif flex flex-col mt-10 relative border-t-2 border-primary">
          ...
          Our commitment to integrity, transparency, and respect for our clients
          and suppliers has earned us a reputation as a trusted partner in the
          pharmaceutical industry. We strive to provide exceptional service,
          competitive pricing, and reliable delivery, while adhering to strict
          quality control measures and environmental standards.
        </div>
      </div>
      <Beat />
    </MaxWidthWrapper>
